...
const FeedUpdateSettings = (props) => {
	...
	return (
		<div className="feed-update-settings">
			<h1>Feed Update Settings</h1>
			<span>
			...
			></input>
			<label htmlFor="add-book-to-shelves">Add a book to your shelves</label>
			<input
				type="checkbox"
				name="add-a-friend"
			...
			<input
				...
				onClick={(e) => {
					...
					props.saveFeedSettings({
						addBookToShelvesInput,
						addAFriendInput,
						voteForABookReviewInput,
						addAQuoteInput,
						recommendABookInput,
						addANewStatusToBookInput,
						followAnAuthorInput,
					});
				}}
			></input>
