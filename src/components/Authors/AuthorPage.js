...
// TODO: Set author as favorite functionality, exhibited star ratings
	...
	useEffect(
		() => {
			const getAuthorInfo = async () => {
				/*let authorObject = await Firebase.getAuthorInfoForAuthorPage(
				...
				const authorObject = {
					...
					favoriteAuthors: [
						...
						},
						{
							...
							image:
								'https://images.gr-assets.com/authors/1562922774p2/33467.jpg',
							bestBookId: '14',
						...
						},
						{
							...
							name: 'Eoin Colfer',
							image:
								'https://images.gr-assets.com/authors/1254336426p2/10896.jpg',
							bestBookId: '14',
						...
						},
						{
							...
							name: 'Ridley Pearson',
							image:
								'https://images.gr-assets.com/authors/1263049167p2/6244.jpg',
							bestBookId: '14',
						...
						},
						{
							...
							name: 'Mo Willems',
							image:
								'https://images.gr-assets.com/authors/1199684071p2/33274.jpg',
							bestBookId: '14',
						...
						},
						{
							...
							name: 'Erin Hunter',
							image:
								'https://images.gr-assets.com/authors/1318547591p2/27498.jpg',
							bestBookId: '14',
				...
				setShelfPopupReadingInputs(
					authorObject.booksByAuthor.map((_book) => '')
				);
