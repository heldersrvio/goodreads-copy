    ...
    return (
        <div id="homepage-top-section">
            ...
            <div id="new-user-presentation">
                <div id="headline">
                    <img src="https://www.goodreads.com/assets/home/headline-e2cd420e71737ff2815d09af5b65c4e4.png" alt="Meet your next favorite book."></img>
                </div>
                <div id="new-account-section">
                    <div id="create-new-account">
                        ...
                        <div id="sign-up-confirmation">
                            ...
                            <span>By clicking “Sign up” I confirm that I am at least 13 years old.</span>
                        </div>
                    </div>
                    <div id="sign-in-sms">
                        <span>or sign in using</span>
                        <button id="facebook-button"><span></span></button>
                        <button id="twitter-button"><span></span></button>
                        <button id="google-button"><span></span></button>
                        <button id="amazon-button"><span></span></button>
                    </div>
                </div>
            </div>
        </div>
